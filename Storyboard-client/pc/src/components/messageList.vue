<template>
  <div class="table-view-cell" :style="{ height: height }">
    <div
      ...
      v-on:touchend="touchEnd($event, index)"
    ...
    <div v-if="btns" class="back-layer">
      <div
        class="left-btn"
        :style="{
          width: leftBtnClickEffect,
          fontSize: btns.leftBtn.style.fontSize,
          backgroundColor: btnBackgroundColors.leftBtn
        }"
        @click="左按钮点击事件()"
      >
        {{ btnLabels.leftBtn }}
      ...
      <div
        ...
        class="right-btn"
        :style="{
          width: rightBtnClickEffect,
          fontSize: btns.rightBtn.style.fontSize,
          backgroundColor: btnBackgroundColors.rightBtn
        }"
        @click="右按钮点击事件()"
      >
        {{ btnLabels.rightBtn }}
